...
public class Car implements Comparable {
  ...
  double price;
    ...
    public static TreeSet<Car> createCarData(Comparator<Car> carComparator) {

        TreeSet<Car> listOfCar = new TreeSet<Car>(carComparator);
        listOfCar = getSet(listOfCar);
        return listOfCar;

    }
    public static TreeSet<Car> createCarData() {
        TreeSet<Car> listOfCar = new TreeSet<Car>();
        listOfCar = getSet(listOfCar);
        return listOfCar;
    }

    private static TreeSet<Car> getSet(TreeSet<Car> listOfCar) {
